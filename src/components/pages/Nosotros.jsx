import { CardMiembro } from '../Index.jsx';
...
const miembrosDelEquipo = [
	...
	},
	{
		...
		linkedin:
			'https://www.linkedin.com/in/santiago-andr%C3%A9s-robledo-garrido-6b4270347/',
	},
];
	...
	return (
		<Container className='border rounded-4 my-3 nosotro'>
			<div className='text-center'>
				...
				<p className='fs-5'>
					¡Bienvenido a Dog-Tor! Conoce a los creadores de este proyecto. Un grupo
					de desarrolladores comprometidos con la excelencia y la innovación.
					Juntos, convertimos ideas en soluciones funcionales y eficientes.
				</p>
			</div>
